//package com.server.myselectshop.util;
//
...
//
//import static com.server.myselectshop.service.ProductService.MIN_MY_PRICE;
//
//@Component
...
//        requestDto.setUsername("Robbie");
//        requestDto.setPassword(passwordEncoder.encode("1234"));
//        requestDto.setEmail("robbie@sparta.com");
//        User testUser = new User(requestDto, UserRoleEnum.USER);
